            ...
            {sessionTypes.map((session) => {
              ...
              return (
                <Link key={session.id} href={session.href}>
                  <div className="group relative h-full bg-[#1e3a5f] hover:bg-[#172554] border border-[#1e3a5f] hover:border-[#FFD700]/50 rounded-xl p-6 transition-all duration-300 cursor-pointer">
                    {session.badge && (
                    ...
                    <div className="flex items-center text-[#FFD700] font-medium group-hover:gap-3 gap-2 transition-all">
                      <span>Book Now</span>
